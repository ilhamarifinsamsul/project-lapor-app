...
@section('title', 'Data Report Category')
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Daftar Data Category</h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $category->name }}</td>
                            <td><img src="{{ asset('storage/' . $category->image) }}" alt="Icon" width="100"></td>
                            <td>
